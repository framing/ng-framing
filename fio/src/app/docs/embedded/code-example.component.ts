...
export class CodeExampleComponent implements OnInit, AfterViewInit {
  ...
  constructor(private elementRef: ElementRef) {
    ...
    [ 'language', 'escape', 'format', 'showcase', 'animated' ].forEach((inputName: string) => {
      if (!(this as any)[inputName]) {
        (this as any)[inputName] = this.elementRef.nativeElement.getAttribute(inputName);
      }
    });
  }
