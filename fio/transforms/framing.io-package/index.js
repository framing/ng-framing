    ...
    new Package(
        ...
        .config(function(
          ...
          readFilesProcessor.sourceFiles = [
            ...
            },
            {
              ...
              include: CONTENTS_PATH + '/root/**/*.html',
              fileReader: 'contentFileReader'
            },
            {
              basePath: CONTENTS_PATH + '/root',
            ...
            },
            {
              ...
              exclude: [
                ...
                '**/_boilerplate/**',
                '**/*/src/styles.css',
                '**/*/src/systemjs-framing-loader.js',
          ...
          generateKeywordsProcessor.ignoreWordsFile = 'fio/transforms/framing.io-package/ignore.words';
        ...
        .config(function(
          ...
          computePathsProcessor.pathTemplates = [
            ...
            {
              docTypes: EXPORT_DOC_TYPES.concat(['component', 'decorator', 'directive', 'pipe']),
